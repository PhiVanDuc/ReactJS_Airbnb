...
export default function ReservationArriving() {
    return (
        <>
            {/* <div className="flex items-center justify-center bg-neutral-100 py-[40px] px-[20px] rounded-[10px]">
                <div className="flex flex-col items-center space-y-[10px]">
                    ...
                    <p className="text-[15px] text-neutral-600 w-full max-w-[250px] text-center">You don’t have any guests arriving today or tomorrow.</p>
                </div>
            </div> */}
            ...
            <div className="grid md:grid-cols-2 grid-cols-1 lg:grid-cols-3 xl:grid-cols-4 gap-[30px]">
                <div className="space-y-[20px]">
                    ...
                    <Button className="font-semibold w-full py-[25px]">Host</Button>
                </div>
            </div>
        </>
    )
