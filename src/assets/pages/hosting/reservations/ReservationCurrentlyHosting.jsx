...
export default function ReservationCurrentlyHosting() {
    return (
        <>
            {/* <div className="flex items-center justify-center bg-neutral-100 py-[40px] px-[20px] rounded-[10px]">
                <div className="flex flex-col items-center space-y-[10px]">
                    ...
                    <p className="text-[15px] text-neutral-600 w-full max-w-[250px] text-center">You don’t have any guests staying with you right now.</p>
                </div>
            </div> */}
