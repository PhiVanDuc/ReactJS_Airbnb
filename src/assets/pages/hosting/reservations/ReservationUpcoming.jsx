        ...
        <>
            {/* <div className="flex items-center justify-center bg-neutral-100 py-[40px] px-[20px] rounded-[10px]">
                <div className="flex flex-col items-center space-y-[10px]">
                    ...
                    <p className="text-[15px] text-neutral-600 w-full max-w-[250px] text-center">You currently don’t have any upcoming guests.</p>
                </div>
            </div> */}
                ...
                <div className="space-y-[20px]">
                    ...
                    <div className="space-y-[15px]">
                        <div className="space-y-[3px]">
                            ...
                            <div className="sm:flex items-center gap-x-[20px] justify-between">
                                <p className="text-[13px] font-medium text-neutral-400">Remaining days: 2 days left.</p>
                    ...
                    <Button className="font-semibold w-full py-[25px]">Cancellation</Button>
                </div>
            </div>
        </>
    )
