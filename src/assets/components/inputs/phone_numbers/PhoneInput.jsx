...
import { useStateHistory } from "./use_state_history";
...
export const PhoneInput = React.forwardRef(function PhoneInput(
	{ value: valueProp, defaultCountry = "US", className, id, required = true, ...rest },
	ref
) {
	const asYouType = new AsYouType();
	const inputRef = ref || React.useRef(null); // Use the ref passed in, or fall back to a local ref
